...
export default function Hierarchy({rows,departments,reload,setNotice}){
  ...
  return <>
    ...
    <div className="hierarchyBanner"><strong>Clean hierarchy view</strong><span> Editing a row to match another row now merges the duplicate and keeps all spare usages linked.</span></div>
