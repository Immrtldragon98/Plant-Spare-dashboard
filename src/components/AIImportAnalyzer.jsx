...
const labels={material_code:'Material Code',alternate_material_code:'Alternate Material Code',spare_name:'Spare Name',description:'Description',tracking_id:'Tracking ID',uom:'UOM',qty:'Qty',safety_stock:'Safety Stock to Maintain',stock_p1:'Stock in P1',stock_p2:'Stock in P2',total_stock:'Total Stock',consumption_p2:'Consumption (P2)',consumption_fy24:'FY24 Consumption',consumption_fy25:'FY25 Consumption',consumption_fy26:'FY26 Consumption',consumption_fy27:'FY27 Consumption',last_issue_date:'Last Issue Date',ideal_pr_qty:'Ideal PR Qty',vendor_code:'Vendor Code',vendor_name:'Vendor Name',pr_number:'PR Number',po_number:'PO Number',pr_raised_date:'PR Raised Date',po_raised_date:'PO Raised Date',rate:'Unit Price / Rate',allowed_qty:'Allowed Qty',total_price:'Total Price',lead_time_years:'Delivery Lead Time',consumption_plan_months:'Consumption Plan (months)',justification:'Justification',expected_date:'Expected Date',out_date:'Out Date',in_date:'In Date',store_qty:'Store Qty',pr_qty:'PR Qty',po_qty:'PO Qty'};
