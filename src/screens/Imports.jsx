...
export default function Imports({history,filters,options,reload,setNotice}){
  ...
  return <>
    ...
    <UniversalImportInbox departmentCode={departmentCode} equipment={area} discipline={discipline} reload={reload} setNotice={setNotice}/>
