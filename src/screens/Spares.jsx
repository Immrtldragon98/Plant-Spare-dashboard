...
export default function Spares(p){
  ...
  return <>
    <div className="pageTitle">
      <div><h1>Spare Materials</h1><p>Manual update: click Edit. Bulk Store / PR / PO / Vendor update: use Imports → SAP Status Update.</p></div>
