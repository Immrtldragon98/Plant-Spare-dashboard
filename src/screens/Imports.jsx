...
const types={
  ...
  pr_planning:{label:'PR Planning',text:'AI maps Safety Stock, Total Stock, Consumption, Last Issue, Ideal PR Qty, Price, Lead Time and Justification for critical-spare screening.',planning:true},
