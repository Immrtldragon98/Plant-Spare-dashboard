...
export default function Imports({history,filters,options,reload,setNotice}){
  ...
  return <>
    ...
    <div className="fileHelp"><strong>Quantity rules</strong><span>Critical = Store/Total Stock below Required/Safety Qty. PR Eligible = Store/Total Stock + open PR + open PO below Required/Safety Qty. Material Code = exactly 3 uppercase letters + 12 digits.</span></div>
